" Modified from http://github.com/michaeljsmith/vim-indent-object


" ii select lines on same and lower indent level
...
" ai select lines on same and higher indent level
